...
<template>
  ...
  >
    <swiper-slide
      ...
      :key="data.id"
      class="relative flex flex-wrap items-center justify-center text-center sm:h-[35rem] lg:h-[40rem] xl:h-[45rem]"
    >
      ...
      >
        ...
        >
          ...
          <div class="w-full px-4 py-4 text-left sm:w-1/2 sm:py-0">
            ...
            <p class="line-clamp-3 text-lg font-bold text-white md:pb-4 md:text-3xl lg:text-5xl">
              {{ data.title }}
            </p>
