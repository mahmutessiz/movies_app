...
<template>
  <div class="mt-12 w-full">
    <div class="w-full p-4">
      <h2 class="text-xl font-bold text-warning sm:text-center">Upcoming & Recently Released</h2>
    </div>
    <ul
    ...
    >
      ...
      >
        <img
          ...
          :alt="data.title"
        />
        <p class="relative flex h-24 flex-col items-center justify-center p-2">
          {{ data.title }}
